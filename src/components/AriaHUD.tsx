...
export default function AriaHUD({ profile }: { profile: UserProfile }) {
  ...
  // Text-to-speech da resposta (opcional, estilo JARVIS falando de volta)
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.coreArea}>
        <div style={{ ...styles.core, ...(processando ? styles.corePulsing : {}) }}>
          <div style={styles.coreInner} />
        </div>
        <span style={styles.coreLabel}>
          {processando ? 'Processando...' : ouvindo ? 'Ouvindo...' : 'ARIA online'}
        </span>
      </div>
